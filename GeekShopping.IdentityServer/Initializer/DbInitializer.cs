    ...
    public class DbInitializer : IDbInitializer
    {
        ...
        public void Initialize()
        {
            ...
            ApplicationUser admin = new ApplicationUser()
            {
                ...
                EmailConfirmed = true,
                PhoneNumber = "(47) 99751-0747",
                FirstName = "Lucas",
                LastName = "Admin"
            };

            _user.CreateAsync(admin, "Lucas123$").GetAwaiter().GetResult();
            ...
            _user.CreateAsync(client, "Lucas123$").GetAwaiter().GetResult();
